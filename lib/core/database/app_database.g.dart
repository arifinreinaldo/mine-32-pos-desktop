...
class $SalesReturnLinesTable extends SalesReturnLines
    with TableInfo<$SalesReturnLinesTable, SalesReturnLine> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $SalesReturnLinesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'sales_return_lines';
  @override
  VerificationContext validateIntegrity(
    Insertable<SalesReturnLine> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  SalesReturnLine map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $SalesReturnLinesTable createAlias(String alias) {
    return $SalesReturnLinesTable(attachedDatabase, alias);
  }
}

class SalesReturnLine extends DataClass implements Insertable<SalesReturnLine> {
  /// UUID v7 string, generated client-side (never an autoincrement int).
  final String id;
  ...
  SalesReturnLinesCompanion toCompanion(bool nullToAbsent) {
    return SalesReturnLinesCompanion(
      id: Value(id),
      createdAt: Value(createdAt),
      updatedAt: Value(updatedAt),
      deletedAt: deletedAt == null && nullToAbsent
      ...
      saleLineId: saleLineId == null && nullToAbsent
          ? const Value.absent()
          : Value(saleLineId),
      variantId: variantId == null && nullToAbsent
          ? const Value.absent()
  ...
  factory SalesReturnLine.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  SalesReturnLine copyWithCompanion(SalesReturnLinesCompanion data) {
    return SalesReturnLine(
      id: data.id.present ? data.id.value : this.id,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('SalesReturnLine(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt, ')
...
class SalesReturnLinesCompanion extends UpdateCompanion<SalesReturnLine> {
  final Value<String> id;
  final Value<int> createdAt;
  final Value<int> updatedAt;
  final Value<int?> deletedAt;
  ...
  final Value<int> unitCostMinor;
  final Value<int> rowid;
  const SalesReturnLinesCompanion({
    this.id = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
    this.deletedAt = const Value.absent(),
  ...
  SalesReturnLinesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       unitPriceMinor = Value(unitPriceMinor),
       lineTotalMinor = Value(lineTotalMinor);
  static Insertable<SalesReturnLine> custom({
    Expression<String>? id,
    Expression<int>? createdAt,
    Expression<int>? updatedAt,
    Expression<int>? deletedAt,
  ...
  SalesReturnLinesCompanion copyWith({
    Value<String>? id,
    Value<int>? createdAt,
    Value<int>? updatedAt,
    Value<int?>? deletedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('SalesReturnLinesCompanion(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt, ')
...
class $PurchaseOrderLinesTable extends PurchaseOrderLines
  ...
  @override
  late final GeneratedColumn<int> qtyOrdered = GeneratedColumn<int>(
    'qty_ordered',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  @override
  late final GeneratedColumn<int> qtyReceived = GeneratedColumn<int>(
    'qty_received',
    aliasedName,
    false,
    type: DriftSqlType.int,
...
class PurchaseOrderLine extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['variant_id'] = Variable<String>(variantId);
    map['description'] = Variable<String>(description);
    map['qty_ordered'] = Variable<int>(qtyOrdered);
    map['qty_received'] = Variable<int>(qtyReceived);
    map['unit_cost_minor'] = Variable<int>(unitCostMinor);
    map['line_total_minor'] = Variable<int>(lineTotalMinor);
    return map;
  }
  ...
  factory PurchaseOrderLine.fromJson(
    ...
    return PurchaseOrderLine(
      ...
      variantId: serializer.fromJson<String>(json['variantId']),
      description: serializer.fromJson<String>(json['description']),
      qtyOrdered: serializer.fromJson<int>(json['qtyOrdered']),
      qtyReceived: serializer.fromJson<int>(json['qtyReceived']),
      unitCostMinor: serializer.fromJson<int>(json['unitCostMinor']),
      lineTotalMinor: serializer.fromJson<int>(json['lineTotalMinor']),
    );
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'variantId': serializer.toJson<String>(variantId),
      'description': serializer.toJson<String>(description),
      'qtyOrdered': serializer.toJson<int>(qtyOrdered),
      'qtyReceived': serializer.toJson<int>(qtyReceived),
      'unitCostMinor': serializer.toJson<int>(unitCostMinor),
      'lineTotalMinor': serializer.toJson<int>(lineTotalMinor),
    };
  }
...
class PurchaseOrderLinesCompanion extends UpdateCompanion<PurchaseOrderLine> {
  ...
  final Value<String> variantId;
  final Value<String> description;
  final Value<int> qtyOrdered;
  final Value<int> qtyReceived;
  final Value<int> unitCostMinor;
  final Value<int> lineTotalMinor;
  final Value<int> rowid;
  ...
  static Insertable<PurchaseOrderLine> custom({
    ...
    Expression<String>? variantId,
    Expression<String>? description,
    Expression<int>? qtyOrdered,
    Expression<int>? qtyReceived,
    Expression<int>? unitCostMinor,
    Expression<int>? lineTotalMinor,
    Expression<int>? rowid,
  }) {
  ...
  PurchaseOrderLinesCompanion copyWith({
    ...
    Value<String>? variantId,
    Value<String>? description,
    Value<int>? qtyOrdered,
    Value<int>? qtyReceived,
    Value<int>? unitCostMinor,
    Value<int>? lineTotalMinor,
    Value<int>? rowid,
  }) {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (qtyOrdered.present) {
      map['qty_ordered'] = Variable<int>(qtyOrdered.value);
    }
    if (qtyReceived.present) {
      map['qty_received'] = Variable<int>(qtyReceived.value);
    }
    if (unitCostMinor.present) {
      map['unit_cost_minor'] = Variable<int>(unitCostMinor.value);
    }
...
class $CustomerReceiptsTable extends CustomerReceipts
    with TableInfo<$CustomerReceiptsTable, CustomerReceipt> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CustomerReceiptsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'customer_receipts';
  @override
  VerificationContext validateIntegrity(
    Insertable<CustomerReceipt> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  CustomerReceipt map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $CustomerReceiptsTable createAlias(String alias) {
    return $CustomerReceiptsTable(attachedDatabase, alias);
  }
}

class CustomerReceipt extends DataClass implements Insertable<CustomerReceipt> {
  /// UUID v7 string, generated client-side (never an autoincrement int).
  final String id;
  ...
  CustomerReceiptsCompanion toCompanion(bool nullToAbsent) {
    return CustomerReceiptsCompanion(
      id: Value(id),
      createdAt: Value(createdAt),
      updatedAt: Value(updatedAt),
      deletedAt: deletedAt == null && nullToAbsent
  ...
  factory CustomerReceipt.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CustomerReceipt copyWithCompanion(CustomerReceiptsCompanion data) {
    return CustomerReceipt(
      id: data.id.present ? data.id.value : this.id,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('CustomerReceipt(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt, ')
...
class CustomerReceiptsCompanion extends UpdateCompanion<CustomerReceipt> {
  final Value<String> id;
  final Value<int> createdAt;
  final Value<int> updatedAt;
  final Value<int?> deletedAt;
  ...
  final Value<String?> reference;
  final Value<int> rowid;
  const CustomerReceiptsCompanion({
    this.id = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
    this.deletedAt = const Value.absent(),
  ...
  CustomerReceiptsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       customerId = Value(customerId),
       amountMinor = Value(amountMinor);
  static Insertable<CustomerReceipt> custom({
    Expression<String>? id,
    Expression<int>? createdAt,
    Expression<int>? updatedAt,
    Expression<int>? deletedAt,
  ...
  CustomerReceiptsCompanion copyWith({
    Value<String>? id,
    Value<int>? createdAt,
    Value<int>? updatedAt,
    Value<int?>? deletedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('CustomerReceiptsCompanion(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('deletedAt: $deletedAt, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $SalesReturnLinesTable salesReturnLines = $SalesReturnLinesTable(
    this,
  );
  ...
  late final $CustomerReceiptsTable customerReceipts = $CustomerReceiptsTable(
    this,
  );
  ...
  late final Index idxReturnSale = Index(
    'idx_return_sale',
    'CREATE INDEX idx_return_sale ON sales_returns (sale_id)',
  );
  late final Index idxReturnlineReturn = Index(
    'idx_returnline_return',
    'CREATE INDEX idx_returnline_return ON sales_return_lines (return_id)',
  );
  ...
  late final Index idxSupplierName = Index(
    'idx_supplier_name',
    'CREATE INDEX idx_supplier_name ON suppliers (name)',
  );
  late final Index idxPoSupplier = Index(
    'idx_po_supplier',
    'CREATE INDEX idx_po_supplier ON purchase_orders (supplier_id)',
  );
  late final Index idxPolinePo = Index(
    'idx_poline_po',
    'CREATE INDEX idx_poline_po ON purchase_order_lines (po_id)',
  );
  late final Index idxReceiptCustomer = Index(
    'idx_receipt_customer',
    'CREATE INDEX idx_receipt_customer ON customer_receipts (customer_id)',
  );
  late final Index idxSuppaySupplier = Index(
    'idx_suppay_supplier',
...
typedef $$SalesReturnsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$SalesReturnLinesTableCreateCompanionBuilder =
    SalesReturnLinesCompanion Function({
      required String id,
      required int createdAt,
      required int updatedAt,
      Value<int?> deletedAt,
...
typedef $$SalesReturnLinesTableUpdateCompanionBuilder =
    SalesReturnLinesCompanion Function({
      Value<String> id,
      Value<int> createdAt,
      Value<int> updatedAt,
...
class $$SalesReturnLinesTableFilterComposer
    extends Composer<_$AppDatabase, $SalesReturnLinesTable> {
  $$SalesReturnLinesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$SalesReturnLinesTableOrderingComposer
    extends Composer<_$AppDatabase, $SalesReturnLinesTable> {
  $$SalesReturnLinesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$SalesReturnLinesTableAnnotationComposer
    extends Composer<_$AppDatabase, $SalesReturnLinesTable> {
  $$SalesReturnLinesTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$SalesReturnLinesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          ...
          $$SalesReturnLinesTableOrderingComposer,
          $$SalesReturnLinesTableAnnotationComposer,
          $$SalesReturnLinesTableCreateCompanionBuilder,
          $$SalesReturnLinesTableUpdateCompanionBuilder,
          (
            SalesReturnLine,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$SalesReturnLinesTableTableManager(
    _$AppDatabase db,
    $SalesReturnLinesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$SalesReturnLinesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$SalesReturnLinesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$SalesReturnLinesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<int> createdAt = const Value.absent(),
...
typedef $$SalesReturnLinesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $SalesReturnLinesTable,
      SalesReturnLine,
      ...
      (
        SalesReturnLine,
        BaseReferences<_$AppDatabase, $SalesReturnLinesTable, SalesReturnLine>,
      ),
      SalesReturnLine,
      PrefetchHooks Function()
    >;
...
class $$PurchaseOrderLinesTableFilterComposer
  ...
  ColumnFilters<int> get qtyOrdered => $composableBuilder(
    column: $table.qtyOrdered,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<int> get qtyReceived => $composableBuilder(
...
class $$PurchaseOrderLinesTableOrderingComposer
  ...
  ColumnOrderings<int> get qtyOrdered => $composableBuilder(
    column: $table.qtyOrdered,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get qtyReceived => $composableBuilder(
    column: $table.qtyReceived,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$PurchaseOrderLinesTableAnnotationComposer
  ...
  GeneratedColumn<int> get qtyOrdered => $composableBuilder(
    column: $table.qtyOrdered,
    builder: (column) => column,
  );

  GeneratedColumn<int> get qtyReceived => $composableBuilder(
    column: $table.qtyReceived,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> variantId = const Value.absent(),
                Value<String> description = const Value.absent(),
                Value<int> qtyOrdered = const Value.absent(),
                Value<int> qtyReceived = const Value.absent(),
                Value<int> unitCostMinor = const Value.absent(),
                Value<int> lineTotalMinor = const Value.absent(),
                Value<int> rowid = const Value.absent(),
...
typedef $$PurchaseOrderLinesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$CustomerReceiptsTableCreateCompanionBuilder =
    CustomerReceiptsCompanion Function({
      required String id,
      required int createdAt,
      required int updatedAt,
      Value<int?> deletedAt,
...
typedef $$CustomerReceiptsTableUpdateCompanionBuilder =
    CustomerReceiptsCompanion Function({
      Value<String> id,
      Value<int> createdAt,
      Value<int> updatedAt,
...
class $$CustomerReceiptsTableFilterComposer
    extends Composer<_$AppDatabase, $CustomerReceiptsTable> {
  $$CustomerReceiptsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CustomerReceiptsTableOrderingComposer
    extends Composer<_$AppDatabase, $CustomerReceiptsTable> {
  $$CustomerReceiptsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CustomerReceiptsTableAnnotationComposer
    extends Composer<_$AppDatabase, $CustomerReceiptsTable> {
  $$CustomerReceiptsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CustomerReceiptsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          ...
          $$CustomerReceiptsTableOrderingComposer,
          $$CustomerReceiptsTableAnnotationComposer,
          $$CustomerReceiptsTableCreateCompanionBuilder,
          $$CustomerReceiptsTableUpdateCompanionBuilder,
          (
            CustomerReceipt,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$CustomerReceiptsTableTableManager(
    _$AppDatabase db,
    $CustomerReceiptsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CustomerReceiptsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CustomerReceiptsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CustomerReceiptsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<int> createdAt = const Value.absent(),
...
typedef $$CustomerReceiptsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CustomerReceiptsTable,
      CustomerReceipt,
      ...
      (
        CustomerReceipt,
        BaseReferences<_$AppDatabase, $CustomerReceiptsTable, CustomerReceipt>,
      ),
      CustomerReceipt,
      PrefetchHooks Function()
    >;
...
class $AppDatabaseManager {
  ...
  $$SalesReturnLinesTableTableManager get salesReturnLines =>
      $$SalesReturnLinesTableTableManager(_db, _db.salesReturnLines);
  ...
  $$CustomerReceiptsTableTableManager get customerReceipts =>
      $$CustomerReceiptsTableTableManager(_db, _db.customerReceipts);
